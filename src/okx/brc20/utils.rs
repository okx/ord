...
mod tests {
    use super::{
        ...
        BRC20_PUBKEY_ADDRESS_P2WPKH,
        BRC20_PUBKEY_ADDRESS_P2TR_KEY,
        BRC20_PUBKEY_ADDRESS_P2SH_P2WPKH,
    };
    use hex::FromHex;
    use {
        bitcoin::{
    ...
    fn test_script() {
        ...
        let script = get_pk_script_by_pubkey_and_type(x_only_pubkey_bytes, BRC20_PUBKEY_ADDRESS_P2WPKH).as_script().to_string();
        ...
        let script = get_pk_script_by_pubkey_and_type(x_only_pubkey_bytes, BRC20_PUBKEY_ADDRESS_P2SH_P2WPKH).as_script().to_string();
